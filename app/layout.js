...
export default function RootLayout({ children }) {
  ...
  return (
    <html lang="en" className={`${Ubuntu_init.variable} ${JetBrains_Mono_init.variable} antialiased scroll-smooth scrollbar-thumb-black overflow-x-hidden`} >
      ...
      <meta property="og:image" content="https://vensah-dev.github.io/icons/Profile Picture Offcial.png" />
      ...
      <meta name="twitter:image" content="https://vensah-dev.github.io/icons/Profile Picture Offcial.png" />
