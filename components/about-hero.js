...
export function AboutHero(){
  return (
    ...
    <div className="bg-about-hero h-screen bg-repeat bg-fixed animate-[bg-pan-left_100s_linear_infinite] md:animate-[bg-pan-left_20s_linear_infinite]">
            {/* <Image
              src={aboutHero}
              alt="Hero Image"
              layout="fill" // Covers the entire container
              objectFit="cover relative"
        ...
        <div className="w-screen h-screen flex items-center bg-opacity-0 bg-gradient-to-t from-primary from-20% to-white-opacity-0 to-85% md:bg-gradient-to-r md:from-primary md:from-20% md:to-white-opacity-0 md:to-85% z-100">
            ...
            <div className='w-full z-0 mx-4 md:mx-16 md:w-2/3 '>
              <div className=' font-jetBrainsMono font-medium tracking-[-0.117em] flex text-h5 md:text-h4'>
