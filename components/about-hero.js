...
export function AboutHero() {
  ...
  return (
    ...
    <div className="bg-about-hero h-screen bg-cover bg-repeat-x bg-inherit lg:bg-fixed animate-[bg-pan-left_100s_linear_infinite] md:animate-[bg-pan-left_30s_linear_infinite]">
      <div className={`w-screen h-screen flex xl:${height > 760 ? "items-center" : "pt-[136px]"} bg-opacity-0 bg-gradient-to-t from-primary from-20% to-white-opacity-0 to-85% md:bg-gradient-to-r md:from-primary md:from-20% md:to-white-opacity-0 md:to-85% z-100`}>
