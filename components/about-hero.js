...
export function AboutHero() {
  ...
  return (
    ...
    <div className="bg-about-hero h-screen bg-repeat-x bg-inherit lg:bg-fixed animate-[bg-pan-left_100s_linear_infinite] md:animate-[bg-pan-left_30s_linear_infinite]">
