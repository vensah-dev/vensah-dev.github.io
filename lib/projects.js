...
export const projects = [
...

    {
        ...
        //project details
        title: "Web Develop",
        description: `Web Develop is an app playground that I made for the Swift Student Challenge 2024. The app playground is designed to teach people the basics of HTML and CSS and get the user interested in web development for them to possibly pursue it in the future.`,
        //images
