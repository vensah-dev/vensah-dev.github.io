...
export const projects = [
    {
        ...
        paragraph: `I started developing Pew Pew in the Sec 3 December Holidays. It's essentially an embodiment of my obsession for space shooter games. I have been developing the game in sprints every few months. This year, I spent a few days to get a prototype version of the game on itch.io for my school’s Student Initiated Learning. As of now, the game has a combat system with 3 different types of enemies that spawn in waves, forcing the player to move around and change playing styles based on the wave composition. There is also a space station which enables the player to purchase the 3 different weapons there are. Since, the prototype version has perma-death, there is also a highscore accessible from the main menu.`,
        showParagraph: true,
