...
export const projects = [
...

    {
        ...
        description: `My computing teacher had assigned the class a pair project as our June Holidays homework. The task was to make an animation on a 16x16 NeoPixel matrix that can optionally be interactive. To be honest I was kind of excited for this. I ended up procrastinating the project up til the last 3 days of June Holidays as I was involved with other projects. With 3 days left the most creative idea I could come up with was a Space Shooters game (again). 
